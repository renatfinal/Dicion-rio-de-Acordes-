...
export function getViolaoShape(tomIndice: number, sufixo: string): GuitarShape {
  ...
  const openChords: Record<string, GuitarShape> = {
    ...
    "0-7+": { status: ['x', 'o', 2, 'o', 'o', 'o'], marcas: [[1,3], [2,2]], cordaRaiz: 1, casaInicial: 1 },
    "0-7": { status: ['x', 'o', 2, 3, 1, 'o'], marcas: [[1,3], [2,2], [3,3], [4,1]], cordaRaiz: 1, casaInicial: 1 },
    "0-m7(b5)": { status: ['x', 'o', 2, 1, 2, 'x'], marcas: [[1,3], [2,4], [3,3], [4,4]], cordaRaiz: 1, casaInicial: 3 },
    "0-m(b5)": { status: ['x', 'o', 2, 1, 2, 'x'], marcas: [[1,3], [2,4], [3,3], [4,4]], cordaRaiz: 1, casaInicial: 3 },
    "0-m7+": { status: ['x', 'o', 3, 2, 2, 'x'], marcas: [[1,3], [2,5], [3,4], [4,4]], cordaRaiz: 1, casaInicial: 3 },
    "0-m(7+)": { status: ['x', 'o', 3, 2, 2, 'x'], marcas: [[1,3], [2,5], [3,4], [4,4]], cordaRaiz: 1, casaInicial: 3 },
    "0-7(b9)": { status: ['x', 'o', 1, 2, 1, 'x'], marcas: [[1,3], [2,2], [3,3], [4,2]], cordaRaiz: 1, casaInicial: 2 },
    "0-7+(#5)": { status: ['x', 'o', 2, 1, 'o', 'o'], marcas: [[1,3], [2,2], [3,1]], cordaRaiz: 1, casaInicial: 1 },
    "0-7+(5#)": { status: ['x', 'o', 2, 1, 'o', 'o'], marcas: [[1,3], [2,2], [3,1]], cordaRaiz: 1, casaInicial: 1 },
    "0-°": { status: ['x', 'o', 2, 1, 2, 'x'], marcas: [[1,3], [2,4], [3,2], [4,4]], cordaRaiz: 1, casaInicial: 2 },
  ...
  const shapeE: Record<string, { status: string[], marcas: number[][] }> = {
    ...
    "7+":     { status: ['o', 'x', 'o', 'o', 'o', 'x'], marcas: [[0,1], [2,1], [3,2], [4,1]] },
    "m7(b5)": { status: ['o', 'x', 'o', 'o', 'o', 'x'], marcas: [[0,2], [2,2], [3,2], [4,1]] },
    "m(b5)":  { status: ['o', 'x', 'o', 'o', 'x', 'x'], marcas: [[0,2], [2,1], [3,2]] },
    "m7+":    { status: ['o', 'x', 'o', 'o', 'o', 'x'], marcas: [[0,1], [2,2], [3,1], [4,1]] },
    "m(7+)":  { status: ['o', 'x', 'o', 'o', 'o', 'x'], marcas: [[0,1], [2,2], [3,1], [4,1]] },
    "7(b9)":  { status: ['o', 'x', 'o', 'o', 'o', 'x'], marcas: [[0,1], [2,1], [3,2], [4,2]] },
    "7+(#5)": { status: ['o', 'x', 'o', 'o', 'o', 'x'], marcas: [[0,1], [2,2], [3,2], [4,2]] },
    "7+(5#)": { status: ['o', 'x', 'o', 'o', 'o', 'x'], marcas: [[0,1], [2,2], [3,2], [4,2]] },
    ...
    "°":      { status: ['o', 'x', 'o', 'o', 'x', 'x'], marcas: [[0,2], [2,1], [3,2]] },
  ...
  const shapeA: Record<string, { status: string[], marcas: number[][] }> = {
    ...
    "7+":     { status: ['x', 'o', 'o', 'o', 'o', 'o'], marcas: [[1,1], [2,3], [3,2], [4,3], [5,1]] },
    "m7(b5)": { status: ['x', 'o', 'o', 'o', 'o', 'x'], marcas: [[1,1], [2,2], [3,1], [4,2]] },
    "m(b5)":  { status: ['x', 'o', 'o', 'o', 'o', 'x'], marcas: [[1,1], [2,2], [3,1], [4,2]] },
    "m7+":    { status: ['x', 'o', 'o', 'o', 'o', 'x'], marcas: [[1,1], [2,3], [3,2], [4,2]] },
    "m(7+)":  { status: ['x', 'o', 'o', 'o', 'o', 'x'], marcas: [[1,1], [2,3], [3,2], [4,2]] },
    "7(b9)":  { status: ['x', 'o', 'o', 'o', 'o', 'x'], marcas: [[1,2], [2,1], [3,2], [4,1]] },
    "7+(#5)": { status: ['x', 'o', 'o', 'o', 'o', 'x'], marcas: [[1,2], [2,1], [3,3], [4,3]] },
    "7+(5#)": { status: ['x', 'o', 'o', 'o', 'o', 'x'], marcas: [[1,2], [2,1], [3,3], [4,3]] },
    ...
    "°":      { status: ['x', 'o', 'o', 'o', 'o', 'x'], marcas: [[1,1], [2,2], [3,1], [4,2]] },
